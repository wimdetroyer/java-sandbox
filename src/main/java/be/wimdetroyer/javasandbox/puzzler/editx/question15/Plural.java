...
public class Plural {
  ...
  private static void countBugs(Integer bugs) {
    ...
    // When clause:
    // https://www.infoq.com/articles/pattern-matching-for-switch/#:~:text=An%20optional%20when%20clause%20can,constants%20when%20using%20enum%20constants.
    switch (bugs) {
